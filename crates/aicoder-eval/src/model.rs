...
use aicoder_core::{TurnExecutionResult, types::ChatCompletionRequest};
...
/// Outcome inferred from both the TurnExecutor result and its final provider finish reason.
...
pub struct EvaluationContext<'a> {
    ...
    pub result: Option<&'a TurnExecutionResult>,
